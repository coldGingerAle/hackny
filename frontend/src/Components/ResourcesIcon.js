...
class ResourcesIcon extends Component {
  constructor(props) {
    super(props);
  }
  render() {
    return(
      <div onClick={this.props.goToResources} style={styles.about} className="col-md-2 animated bounceInLeft">
...
export default Radium(ResourcesIcon);
